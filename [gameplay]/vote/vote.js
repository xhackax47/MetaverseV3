...
class Server_Server {
  constructor(config) {
    this.handleListening = () => {
      ...
      console.log(`Le plugin de vote est actif et écoute sur le port ${address.port}`);
    };
    ...
    this.handleMessage = (msg, rinfo) => {
      ...
      if (payload.Action === "vote") {
        ...
        console.log('Test: Le plugin de vote est correctement relié au site Top-serveurs.');
      } else {
  ...
  start() {
    console.log(`Initialisation plugin vote (v${package_0.version})...`);
