...
Config.Strings = {
	...
	PurchaseJerryCan = "Appuyer sur ~g~E ~w~pour acheter un bidon pour ~g~$" .. Config.JerryCanCost,
	CancelFuelingPump = "Appuyer sur ~g~E ~w~pour annuler le remplissage du réservoir",
	CancelFuelingJerryCan = "Appuyer sur ~g~E ~w~pour annuler le remplissage du bidon",
	NotEnoughCash = "Pas assez de cash",
	RefillJerryCan = "Appuyer sur ~g~E ~w~ pour remplir le bidon pour ",
