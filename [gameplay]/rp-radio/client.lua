...
Radio.Commands = {
    {
        ...
        Help = "Utiliser la radio", -- Command help shown in chatbox when typing the command
        Params = {},
    ...
    },
    {
        ...
        Help = "Modifier la fréquence radio", -- Command help shown in chatbox when typing the command
        Params = {
