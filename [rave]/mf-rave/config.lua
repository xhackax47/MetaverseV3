...
Config.Zones = {
  {
    ...
    opts = {
      ...
      timecycle_strength                = 0.8,                -- timecycle strength             false or float        (0.0 - 2.0)

      secondary_timecycle               = false,              -- secondary timecycle modifier   false or string       (any timecycle filter)
      secondary_timecycle_strength      = false,              -- timecycle strength             false or float        (0.0 - 2.0)   

      cam_shake                         = 'DRUNK_SHAKE',      -- Cam shake                      false or string       (any defined cam shake)
      cam_shake_strength                = 1.5,                -- Cam shake                      false or float        (0.0 - 2.0)
      motion_blur                       = true,               -- Set ped motion blur            false or true
      draw_cubes                        = 20,                 -- Draw 3d cubes?                 false or int          (1 - 30)
    },
  },
  {
    name  = "nightclub",
    ...
    points = {
      vector2(-1601.3392333984,-3007.8784179688),
      vector2(-1602.4569091797,-3018.6928710938),
      vector2(-1589.2819824219,-3019.1484375),
      vector2(-1588.9344482422,-3007.3713378906)
    },
