...
ESX.RegisterServerCallback('metaverse_weaponshop:buyLicense', function(source, cb)
	local xPlayer = ESX.GetPlayerFromId(source)

	if xPlayer.getMoney() >= Config.LicensePrice then
		xPlayer.removeMoney(Config.LicensePrice, "Weapon License")

		TriggerEvent('metaverse_licences:addLicense', source, 'weapon', function()
			cb(true)
		end)
	else
...
ESX.RegisterServerCallback('metaverse_weaponshop:buyWeapon', function(source, cb, weaponName, zone)
	local xPlayer = ESX.GetPlayerFromId(source)
