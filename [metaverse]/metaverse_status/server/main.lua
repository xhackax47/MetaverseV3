local function setPlayerStatus(xPlayer, data)
	...
	TriggerClientEvent('metaverse_status:load', xPlayer.source, data)
end
...
AddEventHandler('metaverse_status:getStatus', function(playerId, statusName, cb)
...
RegisterServerEvent('metaverse_status:update')
AddEventHandler('metaverse_status:update', function(status)
