function OpenBossMenu(society, close, options)
	...
	ESX.TriggerServerCallback('metaverse_society:isBoss', function(isBoss)
		if isBoss then
			...
			ESX.OpenContext("right", elements, function(menu,element)
				if element.value == "check_society_balance" then
					TriggerServerEvent('metaverse_society:checkSocietyBalance', society)
				...
				elseif element.value == "confirm" then
					...
					if amount == nil then
						...
						TriggerServerEvent('metaverse_society:withdrawMoney', society, amount)
						ESX.CloseContext()
					end
				...
				elseif element.value == "confirm2" then
					...
					if amount == nil then
						...
						TriggerServerEvent('metaverse_society:depositMoney', society, amount)
						ESX.CloseContext()
					end
				...
				elseif element.value == "confirm3" then
					...
					if amount == nil then
						...
						TriggerServerEvent('metaverse_society:washMoney', society, amount)
						ESX.CloseContext()
					end
...
function OpenEmployeeList(society, options)
	ESX.TriggerServerCallback('metaverse_society:getEmployees', function(employees)
		local elements = {
			...
			if element.value == "return" then
				...
				ESX.OpenContext("right", elements2, function(menu2,element2)
					...
					elseif element2.value == "fire" then
						...
						ESX.TriggerServerCallback('metaverse_society:setJob', function()
							OpenEmployeeList(society, options)
...
function OpenPromoteMenu(society, employee, options)
	ESX.TriggerServerCallback('metaverse_society:getJob', function(job)
		if not job then
			return
		end
		...
		ESX.OpenContext("right", elements, function(menu,element)
			...
			if element.value == "confirm" then
				...
				elseif amount > Config.MaxSalary then
					...
					ESX.CloseContext()
					ESX.TriggerServerCallback('metaverse_society:setJobSalary', function()
						OpenManageSalaryMenu(society, options)
		...
		ESX.OpenContext("right", elements, function(menu,element)
			...
			if element.value == "confirm" then
				if menu.eles[2].inputValue then
					...
					ESX.TriggerServerCallback('metaverse_society:setJobLabel', function()
					OpenManageGradesMenu(society, options)
...
AddEventHandler('metaverse_society:openBossMenu', function(society, close, options)
