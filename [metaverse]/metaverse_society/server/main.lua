...
AddEventHandler('metaverse_society:registerSociety', registerSociety)
exports("registerSociety", registerSociety)

AddEventHandler('metaverse_society:getSocieties', function(cb)
	cb(RegisteredSocieties)
end)

AddEventHandler('metaverse_society:getSociety', function(name, cb)
	cb(GetSociety(name))
end)

RegisterServerEvent('metaverse_society:checkSocietyBalance')
AddEventHandler('metaverse_society:checkSocietyBalance', function(society)
	local xPlayer = ESX.GetPlayerFromId(source)
	local society = GetSociety(society)

	if xPlayer.job.name ~= society.name then
		print(('metaverse_society: %s attempted to call checkSocietyBalance!'):format(xPlayer.identifier))
		return
	end
...
RegisterServerEvent('metaverse_society:withdrawMoney')
AddEventHandler('metaverse_society:withdrawMoney', function(societyName, amount)
	local source = source
...
RegisterServerEvent('metaverse_society:depositMoney')
AddEventHandler('metaverse_society:depositMoney', function(societyName, amount)
	local source = source
	local xPlayer = ESX.GetPlayerFromId(source)
	local society = GetSociety(societyName)
	if not society then
...
RegisterServerEvent('metaverse_society:washMoney')
AddEventHandler('metaverse_society:washMoney', function(society, amount)
	local source = source
	local xPlayer = ESX.GetPlayerFromId(source)
...
RegisterServerEvent('metaverse_society:putVehicleInGarage')
AddEventHandler('metaverse_society:putVehicleInGarage', function(societyName, vehicle)
	local source = source
	local society = GetSociety(societyName)
	if not society then
	...
	TriggerEvent('metaverse_datastore:getSharedDataStore', society.datastore, function(store)
...
RegisterServerEvent('metaverse_society:removeVehicleFromGarage')
AddEventHandler('metaverse_society:removeVehicleFromGarage', function(societyName, vehicle)
	local source = source
	local society = GetSociety(societyName)
	if not society then
...
ESX.RegisterServerCallback('metaverse_society:getSocietyMoney', function(source, cb, societyName)
	local society = GetSociety(societyName)
	if not society then
...
ESX.RegisterServerCallback('metaverse_society:getEmployees', function(source, cb, society)
	local employees = {}
...
ESX.RegisterServerCallback('metaverse_society:getJob', function(source, cb, society)
...
ESX.RegisterServerCallback('metaverse_society:setJob', function(source, cb, identifier, job, grade, actionType)
	local xPlayer = ESX.GetPlayerFromId(source)
...
ESX.RegisterServerCallback('metaverse_society:setJobSalary', function(source, cb, job, grade, salary)
	local xPlayer = ESX.GetPlayerFromId(source)
...
ESX.RegisterServerCallback('metaverse_society:setJobLabel', function(source, cb, job, grade, label)
	local xPlayer = ESX.GetPlayerFromId(source)
...
ESX.RegisterServerCallback('metaverse_society:getOnlinePlayers', function(source, cb)
...
ESX.RegisterServerCallback('metaverse_society:getVehiclesInGarage', function(source, cb, societyName)
	local society = GetSociety(societyName)
	if not society then
...
ESX.RegisterServerCallback('metaverse_society:isBoss', function(source, cb, job)
...
function isPlayerBoss(playerId, job)
	...
	if xPlayer.job.name == job and xPlayer.job.grade_name == 'boss' then
		...
		print(('metaverse_society: %s attempted open a society boss menu!'):format(xPlayer.identifier))
		return false
	end
end
