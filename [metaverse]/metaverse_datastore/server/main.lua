...
AddEventHandler('metaverse_datastore:getDataStore', function(name, owner, cb)
	cb(GetDataStore(name, owner))
end)

AddEventHandler('metaverse_datastore:getDataStoreOwners', function(name, cb)
	cb(GetDataStoreOwners(name))
end)

AddEventHandler('metaverse_datastore:getSharedDataStore', function(name, cb)
