...
CreateThread(function()
	exports["metaverse_society"]:registerSociety('cardealer', TranslateCap('car_dealer'), 'society_cardealer', 'society_cardealer', 'society_cardealer', {type = 'private'})
end)
...
function SQLVehiclesAndCategories()
	...
	TriggerClientEvent("metaverse_vehicleshop:updateVehiclesAndCategories", -1, vehicles, categories, vehiclesByModel)
end
...
RegisterNetEvent("metaverse_vehicleshop:getVehiclesAndCategories", function()
	TriggerClientEvent("metaverse_vehicleshop:updateVehiclesAndCategories", source, vehicles, categories, vehiclesByModel)
end)

RegisterNetEvent('metaverse_vehicleshop:setVehicleOwnedPlayerId')
AddEventHandler('metaverse_vehicleshop:setVehicleOwnedPlayerId', function(playerId, vehicleProps, model, label)
...
ESX.RegisterServerCallback('metaverse_vehicleshop:getSoldVehicles', function(source, cb)
	MySQL.query('SELECT client, model, plate, soldby, date FROM vehicle_sold ORDER BY DATE DESC', function(result)
		cb(result)
	end)
end)

RegisterNetEvent('metaverse_vehicleshop:rentVehicle')
AddEventHandler('metaverse_vehicleshop:rentVehicle', function(vehicle, plate, rentPrice, playerId)
	local xPlayer, xTarget = ESX.GetPlayerFromId(source), ESX.GetPlayerFromId(playerId)
...
RegisterNetEvent('metaverse_vehicleshop:getStockItem')
AddEventHandler('metaverse_vehicleshop:getStockItem', function(itemName, count)
	local source = source
	local xPlayer = ESX.GetPlayerFromId(source)

	TriggerEvent('metaverse_addoninventory:getSharedInventory', 'society_cardealer', function(inventory)
...
RegisterNetEvent('metaverse_vehicleshop:putStockItems')
AddEventHandler('metaverse_vehicleshop:putStockItems', function(itemName, count)
	local source = source
	local xPlayer = ESX.GetPlayerFromId(source)
...
ESX.RegisterServerCallback('metaverse_vehicleshop:buyVehicle', function(source, cb, model, plate)
	local xPlayer = ESX.GetPlayerFromId(source)
...
ESX.RegisterServerCallback('metaverse_vehicleshop:getCommercialVehicles', function(source, cb)
	MySQL.query('SELECT price, vehicle FROM cardealer_vehicles ORDER BY vehicle ASC', function(result)
		cb(result)
	end)
end)

ESX.RegisterServerCallback('metaverse_vehicleshop:buyCarDealerVehicle', function(source, cb, model)
	local xPlayer = ESX.GetPlayerFromId(source)
	...
	TriggerEvent('metaverse_addonaccount:getSharedAccount', 'society_cardealer', function(account)
...
RegisterNetEvent('metaverse_vehicleshop:returnProvider')
AddEventHandler('metaverse_vehicleshop:returnProvider', function(vehicleModel)
	local xPlayer = ESX.GetPlayerFromId(source)
...
ESX.RegisterServerCallback('metaverse_vehicleshop:getRentedVehicles', function(source, cb)
...
ESX.RegisterServerCallback('metaverse_vehicleshop:giveBackVehicle', function(source, cb, plate)
...
ESX.RegisterServerCallback('metaverse_vehicleshop:resellVehicle', function(source, cb, plate, model)
...
ESX.RegisterServerCallback('metaverse_vehicleshop:getStockItems', function(source, cb)
	TriggerEvent('metaverse_addoninventory:getSharedInventory', 'society_cardealer', function(inventory)
		cb(inventory.items)
	end)
end)

ESX.RegisterServerCallback('metaverse_vehicleshop:getPlayerInventory', function(source, cb)
	local xPlayer = ESX.GetPlayerFromId(source)
...
ESX.RegisterServerCallback('metaverse_vehicleshop:isPlateTaken', function(source, cb, plate)
...
ESX.RegisterServerCallback('metaverse_vehicleshop:retrieveJobVehicles', function(source, cb, type)
	local xPlayer = ESX.GetPlayerFromId(source)
...
RegisterNetEvent('metaverse_vehicleshop:setJobVehicleState')
AddEventHandler('metaverse_vehicleshop:setJobVehicleState', function(plate, state)
	local xPlayer = ESX.GetPlayerFromId(source)
