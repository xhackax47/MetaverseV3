...
RegisterCommand('me', function(playerId, args, rawCommand)
	if playerId == 0 then
		...
		TriggerClientEvent('metaverse_rpchat:sendProximityMessage', -1, playerId, TranslateCap('me_prefix', playerName), args, {255, 0, 0})
	end
end, false)
...
RegisterCommand('do', function(playerId, args, rawCommand)
	if playerId == 0 then
		...
		TriggerClientEvent('metaverse_rpchat:sendProximityMessage', -1, playerId, TranslateCap('do_prefix', playerName), args, {0, 0, 255})
	end
end, false)
