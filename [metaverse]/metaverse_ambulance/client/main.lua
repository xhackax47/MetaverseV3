...
AddEventHandler('esx:onPlayerSpawn', function()
  ...
  if firstSpawn then
    ...
    if Config.SaveDeathStatus then
      ...
      ESX.TriggerServerCallback('metaverse_ambulance:getDeathStatus', function(shouldDie)
        if shouldDie then
          Wait(1000)
...
RegisterNetEvent('metaverse_ambulance:clsearch')
AddEventHandler('metaverse_ambulance:clsearch', function(medicId)
  local playerPed = PlayerPedId()
...
function OnPlayerDeath()
  ...
  TriggerServerEvent('metaverse_ambulance:setDeathStatus', true)
  StartDeathTimer()
  StartDeathCam()
  StartDistressSignal()
end

RegisterNetEvent('metaverse_ambulance:useItem')
AddEventHandler('metaverse_ambulance:useItem', function(itemName)
  ESX.CloseContext()
  ...
  if itemName == 'medikit' then
    ...
    ESX.Streaming.RequestAnimDict(lib, function()
      ...
      TriggerEvent('metaverse_ambulance:heal', 'big', true)
  ...
  elseif itemName == 'bandage' then
    ...
    ESX.Streaming.RequestAnimDict(lib, function()
      ...
      TriggerEvent('metaverse_ambulance:heal', 'small', true)
...
function SendDistressSignal()
  ...
  TriggerServerEvent('metaverse_ambulance:onPlayerDistress')
end
...
function StartDeathTimer()
  ...
  if Config.EarlyRespawnFine then
    ESX.TriggerServerCallback('metaverse_ambulance:checkBalance', function(canPay)
      canPayFine = canPay
    end)
  end
  ...
  CreateThread(function()
    ...
    while bleedoutTimer > 0 and isDead do
      ...
      elseif Config.EarlyRespawnFine and canPayFine then
        ...
        if IsControlPressed(0, 38) and timeHeld > 120 then
          TriggerServerEvent('metaverse_ambulance:payFine')
          RemoveItemsAfterRPDeath()
          break
        end
      end
...
function RemoveItemsAfterRPDeath()
  TriggerServerEvent('metaverse_ambulance:setDeathStatus', false)

  CreateThread(function()
    ESX.TriggerServerCallback('metaverse_ambulance:removeItemsAfterRPDeath', function()
...
AddEventHandler('metaverse_ambulance:revive', function()
  local playerPed = PlayerPedId()
  local coords = GetEntityCoords(playerPed)
  TriggerServerEvent('metaverse_ambulance:setDeathStatus', false)
