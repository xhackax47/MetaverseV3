...
Config.ZonePriceOptions = {
    ...
    Default = 1000000, -- Default Price of a property Default: 250000
}
...
Config.Raiding = {
  ...
  ItemRequired = { -- Item Required to Raid -- Remove To Disable
    ...
    name = "belier", -- Item Name Default: "bread"
    label = "Bélier", -- Item label Default: "Bread"
...
if IsDuplicityVersion() then 
  Config.Logs = {
    Webhook = "https://discordapp.com/api/webhooks/1109938152866582589/Tiy0-oOJeDULWqZ_2blWLXlKxnXbHhUglFFzHC5A6AufETxAJ5O0pLlvLs-9fgdcCca_",
    LogLevel = 1
...
Config.CCTV = {
  Enabled = true,
  PictureWebook = IsDuplicityVersion() and "https://discord.com/api/webhooks/1115028585628049468/1y2-MCaQzLQXs2WdJt7vUu4LFB4crIWAFdv6O8vNmRLhI-goz1QPuYKptlhbORjDs03_" or "DO NOT CHANGE THIS STRING", -- Set a discord webhook here to enable taking pictures of the CCTV (link is copied to user`s clipboard)
...
Config.WardrobeInteraction = function(PropertyId, Interaction)
  ESX.TriggerServerCallback('metaverse_property:getPlayerDressing', function(dressing)
    ...
    ESX.OpenContext("left", elements, function(menu, element)
        TriggerEvent('skinchanger:getSkin', function(skin)
            ESX.TriggerServerCallback('metaverse_property:getPlayerOutfit', function(clothes)
