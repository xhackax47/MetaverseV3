...
Citizen.CreateThread(function()
	while true do
		Citizen.Wait(10)
		if pedDrugDealer < 1 then
			Citizen.Wait(0)
			local processCoords = Config.CircleZones.DrugDealer.coords
			local pedModel = 'g_m_m_chicold_01'
			while not HasModelLoaded(pedModel) do
				RequestModel(GetHashKey(pedModel))
				Wait(100)
			end
			local npc = CreatePed(4, GetHashKey(pedModel), processCoords.x, processCoords.y, processCoords.z, 160.14, false, true)
