...
Config = {
    ...
    ProgressBars = false, -- set to false if you do not use progressBars or using your own
...
Config.Banks = {
	[1] = {
		...
		blip = {enable = true, name = "Banque | Pacific Standard Public Deposit", pos = vector3(231.67,214.91,106.28), display = 4, sprite = 431, color = 5, scale = 0.7},
		police = 6,
		inUse = false, -- do not touch!

		keypads = {
			['start'] = {pos = vector3(262.35,223.03,106.78), text = {[1] = '~r~[E]~s~ Pirater le Keypad', [2] = '~y~[G]~s~ Utiliser la carte d\'accès'} , hacked = false},
			['vault'] = {pos = vector3(252.81,228.49,102.08), text = {[1] = '~r~[E]~s~ Pirater le terminal de la chambre forte', [2] = '~y~[G]~s~ Utiliser la carte d\'accès'}, hacked = false},
		},
	...
	[2] = {
		...
		blip = {enable = true, name = 'Banque | Blaine County Savings Bank', pos = vector3(-110.94,6462.53,31.64), display = 4, sprite = 431, color = 5, scale = 0.7},
		police = 4,
		inUse = false, -- do not touch!

		keypads = {
			['start'] = {pos = vector3(-105.9,6472.11,31.9), text = '~r~[E]~s~ Pirater le Keypad', hacked = false},
			['vault'] = {pos = vector3(-105.51,6475.23,32.0), text = '~r~[E]~s~ Pirater le terminal de la chambre forte', hacked = false},
		},
	...
	[3] = {
		...
		blip = {enable = true, name = 'Banque | Fleeca Bank [Legion Square]', pos = vector3(150.87,-1037.16,29.34), display = 4, sprite = 431, color = 5, scale = 0.7},
		police = 0, -- required cops
		inUse = false, -- do not touch!

		keypads = {
			['start'] = {pos = vector3(147.35,-1046.24,29.37), text = '~r~[E]~s~ Pirater le Keypad', hacked = false},
			['vault'] = {pos = vector3(148.52,-1046.57,29.60), text = '~r~[E]~s~ Pirater le terminal de la chambre forte', hacked = false},
		},
	...
	[4] = {
		...
		blip = {enable = true, name = 'Banque | Fleeca Bank [Alta]', pos = vector3(315.32,-275.55,53.92), display = 4, sprite = 431, color = 5, scale = 0.7},
		police = 3, -- required cops
		inUse = false, -- do not touch!

		keypads = {
			['start'] = {pos = vector3(311.69,-284.55,54.16), text = '~r~[E]~s~ Pirater le Keypad', hacked = false},
			['vault'] = {pos = vector3(312.87,-284.99,54.39), text = '~r~[E]~s~ Pirater le terminal de la chambre forte', hacked = false},
		},
	...
	[5] = {
		...
		blip = {enable = true, name = 'Banque | Fleeca Bank [Burton]', pos = vector3(-349.89,-46.44,49.04), display = 4, sprite = 431, color = 5, scale = 0.7},
		police = 3, -- required cops
		inUse = false, -- do not touch!

		keypads = {
			['start'] = {pos = vector3(-353.52,-55.47,49.20), text = '~r~[E]~s~ Pirater le Keypad', hacked = false},
			['vault'] = {pos = vector3(-352.22,-55.77,49.23), text = '~r~[E]~s~ Pirater le terminal de la chambre forte', hacked = false},
		},
	...
	[6] = {
		...
		blip = {enable = true, name = 'Banque | Fleeca Bank [Rockford Hills]', pos = vector3(-1214.44,-327.5,37.67), display = 4, sprite = 431, color = 5, scale = 0.7},
		police = 3, -- required cops
		inUse = false, -- do not touch!

		keypads = {
			['start'] = {pos = vector3(-1210.49,-336.44,37.98), text = '~r~[E]~s~ Pirater le Keypad', hacked = false},
			['vault'] = {pos = vector3(-1209.30,-335.73, 37.97), text = '~r~[E]~s~ Pirater le terminal de la chambre forte', hacked = false},
		},
	...
	[7] = {
		...
		blip = {enable = true, name = 'Banque | Fleeca Bank [Great Ocean Highway]', pos = vector3(-2966.28,483.01,15.69), display = 4, sprite = 431, color = 5, scale = 0.7},
		police = 3, -- required cops
		inUse = false, -- do not touch!

		keypads = {
			['start'] = {pos = vector3(-2956.55,482.1,15.99), text = '~r~[E]~s~ Pirater le Keypad', hacked = false},
			['vault'] = {pos = vector3(-2956.44,483.35, 15.87), text = '~r~[E]~s~ Pirater le terminal de la chambre forte', hacked = false},
		},
	...
	[8] = {
		...
		blip = {enable = true, name = 'Banque | Fleeca Bank [Grand Senora Desert]', pos = vector3(1175.13,2703.09,38.17), display = 4, sprite = 431, color = 5, scale = 0.7},
		police = 3, -- required cops
		inUse = false, -- do not touch!

		keypads = {
			['start'] = {pos = vector3(1175.64,2712.85,38.30), text = '~r~[E]~s~ Pirater le Keypad', hacked = false},
			['vault'] = {pos = vector3(1174.37,2712.85,38.26), text = '~r~[E]~s~ Pirater le terminal de la chambre forte', hacked = false},
		},
