...
AddEventHandler('metaverse_braquobanques:safecracking:start', SafeCracking.Start)
AddEventHandler('metaverse_braquobanques:safecracking:stop', SafeCracking.Stop)
