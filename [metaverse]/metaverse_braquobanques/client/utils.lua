...
-- Notification
RegisterNetEvent('metaverse_braquobanques:notify')
AddEventHandler('metaverse_braquobanques:notify', function(msg)
	ESX.ShowNotification(msg)
end)

-- Advanced Notification
RegisterNetEvent('metaverse_braquobanques:notifyAdvanced')
AddEventHandler('metaverse_braquobanques:notifyAdvanced', function(sender, subject, msg, textureDict, iconType)
	ESX.ShowAdvancedNotification(sender, subject, msg, textureDict, iconType, false, false, false)
end)

-- Police Notification
RegisterNetEvent('metaverse_braquobanques:police_notify')
AddEventHandler('metaverse_braquobanques:police_notify', function(name)
	...
	TriggerServerEvent('metaverse_braquobanques:sendPoliceAlertSV', coords, message)
end)

-- Police Notification Blip:
RegisterNetEvent('metaverse_braquobanques:sendPoliceAlertCL')
AddEventHandler('metaverse_braquobanques:sendPoliceAlertCL', function(target_coords, message)
	if IsPlayerCop then
