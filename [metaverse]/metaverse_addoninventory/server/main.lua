...
AddEventHandler('metaverse_addoninventory:getInventory', function(name, owner, cb)
	cb(GetInventory(name, owner))
end)

AddEventHandler('metaverse_addoninventory:getSharedInventory', function(name, cb)
