...
RegisterServerEvent('metaverse_tv:add')
AddEventHandler('metaverse_tv:add', function(url, object, coords, scale, offset)
    ...
    TriggerClientEvent('metaverse_tv:update', -1, tosend)
end)

RegisterServerEvent('metaverse_tv:fetch')
AddEventHandler('metaverse_tv:fetch', function()
    local tosend = {}
    ...
    TriggerClientEvent('metaverse_tv:update', source, tosend)
end)

RegisterServerEvent('metaverse_tv:setvolume')
AddEventHandler('metaverse_tv:setvolume', function(id, volume)
    if volume >= 0 and volume <= 10 then
        if data[id] then

            data[id]['Volume'] = volume

            TriggerClientEvent('metaverse_tv:updatevolume', -1, id, volume)

        end
    end
end)

RegisterServerEvent('metaverse_tv:destroy')
AddEventHandler('metaverse_tv:destroy', function(id)
    if data[id] then
        data[id] = nil
        TriggerClientEvent('metaverse_tv:delete', -1, id)
    end
end)