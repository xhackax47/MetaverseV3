...
Strings = {
    ['VideoHelp'] = 'Tape ~b~/tv ~y~youtube id~s~ pour lancer une vidéo.\nExample: ~b~/tv ~y~3hqjseATp4g~s~',
    ['VolumeHelp'] = 'Tape ~b~/volume ~y~(0-10)~s~ pour changer le volume.\nExample: ~b~/volume ~y~5~s~\n\nTape ~b~/tv ~y~youtube id~s~ pour changer de vidéo.\nExemple: ~b~/tv ~y~3hqjseATp4g~s~\n\nTape ~b~/destroy~s~ pour arrêter la vidéo\n\n~INPUT_CONTEXT~ Sync video time',
}