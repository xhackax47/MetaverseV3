    ...
    if Config.EnableSocietyOwnedVehicles then
        ESX.TriggerServerCallback('metaverse_society:getVehiclesInGarage', function(vehicles)
            ...
            ESX.OpenContext("right", elements, function(menu,element)
                ...
                ESX.TriggerServerCallback("metaverse_taxijob:SpawnVehicle", function()
                    return
                end, vehicleProps.model, vehicleProps)
                TriggerServerEvent('metaverse_society:removeVehicleFromGarage', 'taxi', vehicleProps)
                ESX.CloseContext()
            end, function(menu)
...
function DeleteJobVehicle()
    ...
    if Config.EnableSocietyOwnedVehicles then
        ...
        TriggerServerEvent('metaverse_society:putVehicleInGarage', 'taxi', vehicleProps)
...
function OpenTaxiActionsMenu()
    ...
    ESX.OpenContext("right", elements, function(menu,element)
        ...
        elseif element.value == 'boss_actions' then
            TriggerEvent('metaverse_society:openBossMenu', 'taxi', function(data, menu)
                menu.close()
            end)
        end
    end, function(menu)
            ...
            ESX.OpenContext("right", elements2, function(menu2,element2)
                ...
                if amount == nil then
                    ...
                    if closestPlayer == -1 or closestDistance > 3.0 then
                        ...
                        TriggerServerEvent('metaverse_factures:sendBill', GetPlayerServerId(closestPlayer), 'society_taxi',
                            'Taxi', amount)
...
function OpenGetStocksMenu()
    ESX.TriggerServerCallback('metaverse_taxijob:getStockItems', function(items)
        local elements = {
        ...
        ESX.OpenContext("right", elements, function(menu,element)
            ...
            ESX.OpenContext("right", elements2, function(menu2,element2)
                ...
                if count == nil then
                    ...
                    ESX.CloseContext()
                    TriggerServerEvent('metaverse_taxijob:getStockItem', itemName, count)
...
function OpenPutStocksMenu()
    ESX.TriggerServerCallback('metaverse_taxijob:getPlayerInventory', function(inventory)
        local elements = {
        ...
        ESX.OpenContext("right", elements, function(menu,element)
            ...
            ESX.OpenContext("right", elements2, function(menu2,element2)
                ...
                if count == nil then
                    ...
                    TriggerServerEvent('metaverse_taxijob:putStockItems', itemName, count)
                    Wait(1000)
                    OpenPutStocksMenu()
                end
            end)
...
AddEventHandler('metaverse_taxijob:hasEnteredMarker', function(zone)
...
AddEventHandler('metaverse_taxijob:hasExitedMarker', function(zone)
    ESX.CloseContext()
    CurrentAction = nil
end)
    ...
    while true do
        ...
        if ESX.PlayerData.job and ESX.PlayerData.job.name == 'taxi' then
            ...
            if (isInMarker and not HasAlreadyEnteredMarker) or (isInMarker and LastZone ~= currentZone) then
                ...
                TriggerEvent('metaverse_taxijob:hasEnteredMarker', currentZone)
            end

            if not isInMarker and HasAlreadyEnteredMarker then
                HasAlreadyEnteredMarker = false
                TriggerEvent('metaverse_taxijob:hasExitedMarker', LastZone)
            end
        end
        Wait(sleep)
    end
                        ...
                        if CustomerEnteredVehicle then
                            ...
                            if targetDistance <= 10.0 then
                                ...
                                TaskGoStraightToCoord(CurrentCustomer, targetCoords.x, targetCoords.y, targetCoords.z,
                                    1.0, -1, 0.0, 0.0)
                                SetEntityAsMissionEntity(CurrentCustomer, false, true)
                                TriggerServerEvent('metaverse_taxijob:success')
                                RemoveBlip(DestinationBlip)
