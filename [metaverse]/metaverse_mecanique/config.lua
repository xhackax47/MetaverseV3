...
Config.Zones = {
	...
	MechanicActions = {
		Pos   = vector3(-196.0531, -1339.4468, 34.8994),
	...
	Garage = {
		Pos   = vector3(2340.7310, 3126.1807, 48.2087 ),
		Size  = { x = 1.0, y = 1.0, z = 1.0 },
		Color = { r = 50, g = 200, b = 50 },
		Type  = 21
	},
	...
	Craft = {
		Pos   = vector3(-196.2810, -1318.5641, 31.0894 ),
		Size  = { x = 1.0, y = 1.0, z = 1.0 },
		Color = { r = 50, g = 200, b = 50 },
		Type  = 21
	},
	...
	VehicleSpawnPoint = {
		Pos   = vector3(-182.6320, -1337.5516, 31.2978 ),
		Size  = { x = 1.5, y = 1.5, z = 1.0 },
		Type  = -1
	},

	VehicleDeleter = {
		Pos   = vector3(-182.4775, -1313.7531, 30.2973 ),
	...
	VehicleDelivery = {
		Pos   = vector3(-188.4251, -1274.2640, 31.2386 ),
