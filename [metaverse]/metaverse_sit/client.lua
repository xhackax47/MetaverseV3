...
function wakeup()
	...
	TriggerServerEvent('metaverse_sit:leavePlace', currentSitCoords)
...
function sit(object, modelName, data)
	...
	ESX.TriggerServerCallback('metaverse_sit:getPlace', function(occupied)
		if occupied then
			...
			TriggerServerEvent('metaverse_sit:takePlace', objectCoords)
