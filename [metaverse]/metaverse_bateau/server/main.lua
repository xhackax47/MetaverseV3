...
ESX.RegisterServerCallback('metaverse_bateau:buyBoat', function(source, cb, vehicleProps)
...
RegisterServerEvent('metaverse_bateau:takeOutVehicle')
AddEventHandler('metaverse_bateau:takeOutVehicle', function(plate)
	local xPlayer = ESX.GetPlayerFromId(source)
...
ESX.RegisterServerCallback('metaverse_bateau:storeVehicle', function (source, cb, plate)
	local xPlayer = ESX.GetPlayerFromId(source)
...
ESX.RegisterServerCallback('metaverse_bateau:getGarage', function(source, cb)
	local xPlayer = ESX.GetPlayerFromId(source)
...
ESX.RegisterServerCallback('metaverse_bateau:buyBoatLicense', function(source, cb)
	local xPlayer = ESX.GetPlayerFromId(source)

	if xPlayer.getMoney() >= Config.LicensePrice then
		xPlayer.removeMoney(Config.LicensePrice, "Achat License Bateau")

		TriggerEvent('metaverse_licences:addLicense', source, 'boat', function()
			cb(true)
		end)
	else
		cb(false)
