...
--[[
		...
		{ -- Cayo
			GaragePos  = vector3(4930.41, -5145.83, 1.46),
			SpawnPoint = vector4(4915.11, -5142.11, 0.0, 70.0),
			StorePos   = vector3(4932.19, -5152.48, 0.3),
			StoreTP    = vector4(4939.63, -5149.93, 1.46, 0.0)
		}
	},
