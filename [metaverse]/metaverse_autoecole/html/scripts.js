...
$(".btnQuestion").click(function () {
	$.post('http://metaverse_autoecole/question', JSON.stringify({}));
});

$(".btnClose").click(function () {
	$.post('http://metaverse_autoecole/close', JSON.stringify({}));
	userAnswer = [];
	goodAnswer = [];
	questionUsed = [];
	questionNumber = 1;
...
$(".btnKick").click(function () {
	$.post('http://metaverse_autoecole/kick', JSON.stringify({}));
	userAnswer = [];
	goodAnswer = [];
	questionUsed = [];
	questionNumber = 1;
