...
AddEventHandler('esx:playerLoaded', function()
    ESX.TriggerServerCallback('metaverse_lscustom:getVehiclesPrices', function(vehicles)
        Vehicles = vehicles
    end)
end)

RegisterNetEvent('metaverse_lscustom:installMod')
AddEventHandler('metaverse_lscustom:installMod', function()
    local vehicle = GetVehiclePedIsIn(PlayerPedId(), false)
    local NetId = NetworkGetNetworkIdFromEntity(vehicle)
    myCar = ESX.Game.GetVehicleProperties(vehicle)
    TriggerServerEvent('metaverse_lscustom:refreshOwnedVehicle', myCar, NetId)
end)

RegisterNetEvent('metaverse_lscustom:restoreMods', function(netId, props)
...
RegisterNetEvent('metaverse_lscustom:cancelInstallMod')
AddEventHandler('metaverse_lscustom:cancelInstallMod', function()
    local vehicle = GetVehiclePedIsIn(PlayerPedId(), false)
...
AddEventHandler('onClientResourceStop', function(resource)
	if resource == GetCurrentResourceName() then
		if lsMenuIsShowed then
			TriggerEvent('metaverse_lscustom:cancelInstallMod')
		end
	end
end)
...
function OpenLSMenu(elems, menuName, menuTitle, parent)
    ESX.UI.Menu.Open('default', GetCurrentResourceName(), menuName, {
        ...
        for k, v in pairs(Config.Menus) do
            ...
            if k == data.current.modType or isRimMod then
                ...
                if data.current.label == TranslateCap('by_default') or string.match(data.current.label, TranslateCap('installed')) then
                    ...
                    myCar = ESX.Game.GetVehicleProperties(vehicle)
                    TriggerServerEvent('metaverse_lscustom:refreshOwnedVehicle', myCar, NetworkGetNetworkIdFromEntity(vehicle))
                else
                    ...
                    if isRimMod then
                        ...
                        TriggerServerEvent('metaverse_lscustom:buyMod', price)
        ...
        if parent == nil then
            ...
            TriggerServerEvent('metaverse_lscustom:stopModing', myCar.plate)
            myCar = {}
        end
                    ...
                    if #(coords - zonePos) < 10.0 then
                        ...
                        if not lsMenuIsShowed then
                            ...
                            if IsControlJustReleased(0, 38) then
                                ...
                                local netId = NetworkGetNetworkIdFromEntity(vehicle)
                                TriggerServerEvent('metaverse_lscustom:startModing', myCar, netId)
