$('#shutdownbutton').click(function() {
    $.post('https://metaverse_autoradio/action', JSON.stringify({
        action: 'exit'
    }));
})
...
function getNameFile(url) {
	if (url == undefined) {
		vidname = "Aucun son";
		document.getElementById("testrec").innerHTML = "<b>Lecture:</b><marquee direction = 'right'> "+ vidname + "</marquee>"
	} else {
