...
Config.ItemInVehicle = "autoradio" -- Put here, if you want the radio to be an item, inside "", like "radio". With or false you will need to do /carradio
Config.CommandVehicle = false -- Only will work if Config.ItemInVehicle == false
