...
AddEventHandler('FIREAC:AddAdminOption', function (DATA)
    if DATA ~= nil then
        Access = true
        DrawNotificationForPlayer('~h~~o~METAVERSE_AC:~s~~g~~h~ Connecté en tant qu\'administrateur !~s~')
    end
end)
...
-- MENU 2
local menu2 = MenuV:CreateMenu(false, 'METAVERSE AC Admin Tools', 'centerright', 51, 102, 255, 'size-125', 'default_native', 'menuv', 'FIREAC: Admin Menu')
...
menu2_revive:On('select', function(item)
    TriggerEvent('qb-ambulancejob:revive') -- Change trigger if needed
end)
...
-- MENU 3
local menu3 = MenuV:CreateMenu(false, 'METAVERSE AC: Connected Players', 'centerright', 51, 102, 255, 'size-125', 'default_native', 'menuv', 'METAVERSE AC: Connected Players')
...
-- MENU 4
local menu4 = MenuV:CreateMenu(false, 'METAVERSE AC Server Tools', 'centerright', 51, 102, 255, 'size-125', 'default_native', 'menuv', 'METAVERSE AC: Server Tools')
...
-- MENU 5
local menu5 = MenuV:CreateMenu(false, 'METAVERSE AC Teleport Options', 'centerright', 51, 102, 255, 'size-125', 'default_native', 'menuv', 'FIREAC: Teleport Options')
...
-- MENU 6
local menu6 = MenuV:CreateMenu(false, 'METAVERSE AC Vehicle Tools', 'centerright', 51, 102, 255, 'size-125', 'default_native', 'menuv', 'METAVERSE AC: Vehicle Tools')
...
-- MENU 7
local menu7 = MenuV:CreateMenu(false, 'METAVERSE AC Admin Tools', 'centerright', 51, 102, 255, 'size-125', 'default_native', 'menuv', 'METAVERSE AC: TP Tools Tools')
local menu7_acinfo = menu7:AddButton({ icon = ''..Emoji.info..'', label = 'Version: 6.0', description = '' })
local menu7_creatorac = menu7:AddButton({ icon = ''..Emoji.info..'', label = 'METAVERSE AC Dev: AmIrReZa#2080', description = '' })
...
-- PRINCIPAL MENU
local menu = MenuV:CreateMenu(false, ''..Emoji.Fire..' METAVERSE AC Admin Menu '..Emoji.Fire..'', 'centerright', 51, 102, 255, 'size-125', 'default_native', 'menuv', 'METAVERSE AC: Main Menu')
...
function spectate(target, coords)
	...
	if player == -1 then return QBCore.Functions.Notify("~h~~o~[METAVERSE AC]:~s~Player Not Found !", "error") end
...
RegisterKeyMapping('fireacmenu', 'METAVERSE AC Admin Menu', 'keyboard', FIREAC.AdminMenu.Key)
