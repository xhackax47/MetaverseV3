...
TriggerEvent('gcphone:registerNumber', 'unicorn', _U('unicorn_customer'), true, true)
TriggerEvent('metaverse_society:registerSociety', 'unicorn', 'Unicorn', 'society_unicorn', 'society_unicorn', 'society_unicorn', {type = 'private'})



RegisterServerEvent('metaverse_unicorn:getStockItem')
AddEventHandler('metaverse_unicorn:getStockItem', function(itemName, count)

  local xPlayer = ESX.GetPlayerFromId(source)

  TriggerEvent('metaverse_addoninventory:getSharedInventory', 'society_unicorn', function(inventory)
...
ESX.RegisterServerCallback('metaverse_unicorn:getStockItems', function(source, cb)
...
RegisterServerEvent('metaverse_unicorn:putStockItems')
AddEventHandler('metaverse_unicorn:putStockItems', function(itemName, count)
...
RegisterServerEvent('metaverse_unicorn:getFridgeStockItem')
AddEventHandler('metaverse_unicorn:getFridgeStockItem', function(itemName, count)

  local xPlayer = ESX.GetPlayerFromId(source)

  TriggerEvent('metaverse_addoninventory:getSharedInventory', 'society_unicorn_fridge', function(inventory)
...
ESX.RegisterServerCallback('metaverse_unicorn:getFridgeStockItems', function(source, cb)
...
RegisterServerEvent('metaverse_unicorn:putFridgeStockItems')
AddEventHandler('metaverse_unicorn:putFridgeStockItems', function(itemName, count)
...
RegisterServerEvent('metaverse_unicorn:buyItem')
AddEventHandler('metaverse_unicorn:buyItem', function(itemName, price, itemLabel)
    ...
    TriggerEvent('metaverse_addonaccount:getSharedAccount', 'society_unicorn', function(account)
...
RegisterServerEvent('metaverse_unicorn:craftingCoktails')
AddEventHandler('metaverse_unicorn:craftingCoktails', function(itemValue)
...
ESX.RegisterServerCallback('metaverse_unicorn:getVaultWeapons', function(source, cb)

  TriggerEvent('metaverse_datastore:getSharedDataStore', 'society_unicorn', function(store)
...
ESX.RegisterServerCallback('metaverse_unicorn:addVaultWeapon', function(source, cb, weaponName)
...
ESX.RegisterServerCallback('metaverse_unicorn:removeVaultWeapon', function(source, cb, weaponName)
...
ESX.RegisterServerCallback('metaverse_unicorn:getPlayerInventory', function(source, cb)
