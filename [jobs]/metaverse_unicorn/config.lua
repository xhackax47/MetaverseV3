...
-------- SHOPS --------
    ...
    NoAlcool = {
        ...
        Type  = 23,
        Items = {
            { name = 'soda',        label = _U('soda'),     price = 40 },
            { name = 'jusfruit',    label = _U('jusfruit'), price = 30 },
            { name = 'icetea',      label = _U('icetea'),   price = 40 },
            { name = 'energy',      label = _U('energy'),   price = 70 },
            { name = 'drpepper',    label = _U('drpepper'), price = 100 },
            { name = 'limonade',    label = _U('limonade'), price = 100 }
        },
    },
    ...
    Apero = {
        ...
        Type  = 23,
        Items = {
            { name = 'bolcacahuetes',   label = _U('bolcacahuetes'),    price = 50 },
            { name = 'bolnoixcajou',    label = _U('bolnoixcajou'),     price = 50 },
            { name = 'bolpistache',     label = _U('bolpistache'),      price = 50 },
            { name = 'bolchips',        label = _U('bolchips'),         price = 50 },
            { name = 'saucisson',       label = _U('saucisson'),        price = 75 },
            { name = 'grapperaisin',    label = _U('grapperaisin'),     price = 100 }
        },
    },
