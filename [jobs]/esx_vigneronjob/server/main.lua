...
TriggerEvent('gcphone:registerNumber', 'vigne', _U('vigneron_client'), true, true)
TriggerEvent('metaverse_society:registerSociety', 'vigne', 'Vigneron', 'society_vigne', 'society_vigne', 'society_vigne', {type = 'private'})
			...
			elseif xPlayer.getInventoryItem('jus_raisin').count <= 0 and vine == 0then
				...
				if (jus == 1) then
					SetTimeout(1100, function()
						...
						TriggerEvent('metaverse_addonaccount:getSharedAccount', 'society_vigne', function(account)
...
AddEventHandler('esx_vigneronjob:getStockItem', function(itemName, count)
	...
	TriggerEvent('metaverse_addoninventory:getSharedInventory', 'society_vigne', function(inventory)
...
ESX.RegisterUsableItem('jus_raisin', function(source)
	...
	TriggerClientEvent('metaverse_status:add', source, 'hunger', 40000)
	TriggerClientEvent('metaverse_status:add', source, 'thirst', 120000)
...
ESX.RegisterUsableItem('grand_cru', function(source)
	...
	TriggerClientEvent('metaverse_status:add', source, 'drunk', 400000)
	TriggerClientEvent('metaverse_basicneeds:onDrink', source)
