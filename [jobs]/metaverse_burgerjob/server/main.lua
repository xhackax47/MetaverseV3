...
TriggerEvent('gcphone:registerNumber', 'burgershot', _U('burgershot_customer'), true, true)
TriggerEvent('metaverse_society:registerSociety', 'burgershot', 'burgershot', 'society_burgershot', 'society_burgershot', 'society_burgershot', {type = 'private'})
...
RegisterServerEvent('metaverse_burgerjob:startHarvest')
AddEventHandler('metaverse_burgerjob:startHarvest', function(zone)
...
RegisterServerEvent('metaverse_burgerjob:stopHarvest')
AddEventHandler('metaverse_burgerjob:stopHarvest', function()
  local _source = source
...
RegisterServerEvent('metaverse_burgerjob:startTransform')
AddEventHandler('metaverse_burgerjob:startTransform', function(zone)
  local _source = source
...
RegisterServerEvent('metaverse_burgerjob:stopTransform')
AddEventHandler('metaverse_burgerjob:stopTransform', function()
  local _source = source
      ...
      if xPlayer.getInventoryItem('sachetketchup').count <= 0 then
        ...
        if (ketchup == 1) then
          SetTimeout(1100, function()
            ...
            TriggerEvent('metaverse_addonaccount:getSharedAccount', 'society_burgershot', function(account)
...
RegisterServerEvent('metaverse_burgerjob:startSell')
AddEventHandler('metaverse_burgerjob:startSell', function(zone)
  local _source = source
...
RegisterServerEvent('metaverse_burgerjob:stopSell')
AddEventHandler('metaverse_burgerjob:stopSell', function()
  local _source = source
...
RegisterServerEvent('metaverse_burgerjob:getStockItem')
AddEventHandler('metaverse_burgerjob:getStockItem', function(itemName, count)

  local xPlayer = ESX.GetPlayerFromId(source)

  TriggerEvent('metaverse_addoninventory:getSharedInventory', 'society_burgershot', function(inventory)
...
ESX.RegisterServerCallback('metaverse_burgerjob:getStockItems', function(source, cb)
...
RegisterServerEvent('metaverse_burgerjob:putStockItems')
AddEventHandler('metaverse_burgerjob:putStockItems', function(itemName, count)
...
RegisterServerEvent('metaverse_burgerjob:getFridgeStockItem')
AddEventHandler('metaverse_burgerjob:getFridgeStockItem', function(itemName, count)

  local xPlayer = ESX.GetPlayerFromId(source)

  TriggerEvent('metaverse_addoninventory:getSharedInventory', 'society_burgershot_fridge', function(inventory)
...
ESX.RegisterServerCallback('metaverse_burgerjob:getFridgeStockItems', function(source, cb)
...
RegisterServerEvent('metaverse_burgerjob:putFridgeStockItems')
AddEventHandler('metaverse_burgerjob:putFridgeStockItems', function(itemName, count)
...
RegisterServerEvent('metaverse_burgerjob:buyItem')
AddEventHandler('metaverse_burgerjob:buyItem', function(itemName, price, itemLabel)
...
RegisterServerEvent('metaverse_burgerjob:ingredientgBurger')
AddEventHandler('metaverse_burgerjob:ingredientgBurger', function(itemValue)
...
RegisterServerEvent('metaverse_burgerjob:craftingBurger')
AddEventHandler('metaverse_burgerjob:craftingBurger', function(itemValue)
...
ESX.RegisterServerCallback('metaverse_burgerjob:getVaultWeapons', function(source, cb)

  TriggerEvent('metaverse_datastore:getSharedDataStore', 'society_burgershot', function(store)
...
ESX.RegisterServerCallback('metaverse_burgerjob:addVaultWeapon', function(source, cb, weaponName)
...
ESX.RegisterServerCallback('metaverse_burgerjob:removeVaultWeapon', function(source, cb, weaponName)
...
ESX.RegisterServerCallback('metaverse_burgerjob:getPlayerInventory', function(source, cb)
...
TriggerClientEvent('metaverse_status:add', source, 'hunger', 200000)
TriggerClientEvent('metaverse_basicneeds:onEat', source)
...
TriggerClientEvent('metaverse_status:add', source, 'hunger', 100000)
TriggerClientEvent('metaverse_basicneeds:onEat', source)
...
TriggerClientEvent('metaverse_status:add', source, 'thirst', 200000)
TriggerClientEvent('metaverse_basicneeds:onDrink', source)
...
TriggerClientEvent('metaverse_status:add', source, 'thirst', 100000)
TriggerClientEvent('metaverse_basicneeds:onDrink', source)
...
TriggerClientEvent('metaverse_status:add', source, 'thirst', 250000)
TriggerClientEvent('metaverse_basicneeds:onDrink', source)
