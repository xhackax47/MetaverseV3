...
function OpenVehicleSpawnerMenu()
  ...
  if Config.EnableSocietyOwnedVehicles then
    ...
    ESX.TriggerServerCallback('metaverse_society:getVehiclesInGarage', function(garageVehicles)
      ...
      ESX.UI.Menu.Open(
        ...
        function(data, menu)
          ...
          TriggerServerEvent('metaverse_society:removeVehicleFromGarage', 'burgershot', vehicleProps)
      ...
      if data.current.value == 'menu_crafting' then
          ...
          ESX.UI.Menu.Open(
              ...
              function(data2, menu2)
                ...
                TriggerServerEvent('metaverse_burgerjob:craftingBurger', data2.current.value)
       ...
       if data.current.value == 'menu_ingredient' then
          ...
          ESX.UI.Menu.Open(
              ...
              function(data2, menu3)
                ...
                TriggerServerEvent('metaverse_burgerjob:ingredientgBurger', data2.current.value)
                animsAction({ lib = "mini@drinking", anim = "shots_barman_b" })
    ...
    function(data, menu)
      ...
      if player ~= -1 and distance <= 3.0 then
        ...
        if amount == nil then
            ...
            TriggerServerEvent('metaverse_factures:sendBill', GetPlayerServerId(player), 'society_burgershot', _U('billing'), amount)
        end
...
function OpenGetStocksMenu()
  ...
  ESX.TriggerServerCallback('metaverse_burgerjob:getStockItems', function(items)
        ...
        ESX.UI.Menu.Open(
          ...
          function(data2, menu2)
            ...
            if count == nil then
              ...
              TriggerServerEvent('metaverse_burgerjob:getStockItem', itemName, count)
            end
...
ESX.TriggerServerCallback('metaverse_burgerjob:getPlayerInventory', function(inventory)
        ...
        ESX.UI.Menu.Open(
          ...
          function(data2, menu2)
            ...
            if count == nil then
              ...
              TriggerServerEvent('metaverse_burgerjob:putStockItems', itemName, count)
            end
...
function OpenGetFridgeStocksMenu()
  ...
  ESX.TriggerServerCallback('metaverse_burgerjob:getFridgeStockItems', function(items)
        ...
        ESX.UI.Menu.Open(
          ...
          function(data2, menu2)
            ...
            if count == nil then
              ...
              TriggerServerEvent('metaverse_burgerjob:getFridgeStockItem', itemName, count)
            end
        ...
        ESX.UI.Menu.Open(
          ...
          function(data2, menu2)
            ...
            if count == nil then
              ...
              TriggerServerEvent('metaverse_burgerjob:putFridgeStockItems', itemName, count)
            end
...
function OpenGetWeaponMenu()
  ...
  ESX.TriggerServerCallback('metaverse_burgerjob:getVaultWeapons', function(weapons)
    ...
    ESX.UI.Menu.Open(
      ...
      function(data, menu)
        ...
        ESX.TriggerServerCallback('metaverse_burgerjob:removeVaultWeapon', function()
          OpenGetWeaponMenu()
...
function OpenPutWeaponMenu()
  ...
  ESX.UI.Menu.Open(
    ...
    function(data, menu)
      ...
      ESX.TriggerServerCallback('metaverse_burgerjob:addVaultWeapon', function()
        OpenPutWeaponMenu()
      end, data.current.value)
...
function OpenShopMenu(zone)
    ...
    ESX.UI.Menu.Open(
        ...
        function(data, menu)
            TriggerServerEvent('metaverse_burgerjob:buyItem', data.current.value, data.current.price, data.current.realLabel)
        end,
        function(data, menu)
            menu.close()
        end
...
AddEventHandler('metaverse_burgerjob:hasEnteredMarker', function(zone)
...
AddEventHandler('metaverse_burgerjob:hasExitedMarker', function(zone)
    ...
    while true do
        ...
        if IsJobTrue() then
            ...
            if (isInMarker and not HasAlreadyEnteredMarker) or (isInMarker and LastZone ~= currentZone) then
                ...
                TriggerEvent('metaverse_burgerjob:hasEnteredMarker', currentZone)
            end

            if not isInMarker and HasAlreadyEnteredMarker then
                HasAlreadyEnteredMarker = false
                TriggerEvent('metaverse_burgerjob:hasExitedMarker', LastZone)
            end
    ...
    if CurrentAction ~= nil then
      ...
      if IsControlJustReleased(0,  Keys['E']) and IsJobTrue() then
        ...
        if CurrentAction == 'ketchup_harvest' then
          TriggerServerEvent('metaverse_burgerjob:startHarvest', CurrentActionData.zone)
        end
        if CurrentAction == 'ketchup_sachet' then
          TriggerServerEvent('metaverse_burgerjob:startTransform', CurrentActionData.zone)
        end
        if CurrentAction == 'farm_resell' then
          TriggerServerEvent('metaverse_burgerjob:startSell', CurrentActionData.zone)
        end
        ...
        if CurrentAction == 'delete_vehicle' then
          ...
          if Config.EnableSocietyOwnedVehicles then
            ...
            TriggerServerEvent('metaverse_society:putVehicleInGarage', 'burgershot', vehicleProps)
        ...
        if CurrentAction == 'menu_boss_actions' and IsGradeBoss() then
          ...
          TriggerEvent('metaverse_society:openBossMenu', 'burgershot', function(data, menu)
