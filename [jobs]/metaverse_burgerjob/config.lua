...
-------- SHOPS --------
    ...
    Alim = {
        ...
        Type  = 0,
        Items = {
            { name = 'salads',      label = _U('salads'),   price = 30 },
            { name = 'tomater',      label = _U('tomater'),   price = 20 },
            { name = 'steakc',       label = _U('steakc'),    price = 70 },
            { name = 'bread',     label = _U('bread'),  price = 20 },
            { name = 'fromage',    label = _U('fromage'), price = 30 },
            { name = 'patate',    label = _U('patate'), price = 30 },
